import { Directive, EmbeddedViewRef, Input, NgModule, TemplateRef, ViewContainerRef } from '@angular/core';
import { _filter } from 'array-helpers';
import { Immutable, ImmutableArray, Maybe } from 'global-types';
import { debounceAfterFirst } from 'global-utils';
import { BehaviorSubject, combineLatest } from 'rxjs';
import { map } from 'rxjs/operators';
import { ActiveStringFilterConfig } from './active-string-filter.config';
...
@NgModule({
    declarations: [ActiveStringFilterDirective],
    exports: [ActiveStringFilterDirective]
})
export class ActiveStringFilterModule {}