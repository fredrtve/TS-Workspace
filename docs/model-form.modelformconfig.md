...
```typescript
export interface ModelFormConfig<TState extends object, TModel extends StateModels<TState>, TForm extends object = TModel extends object ? TModel : object, TFormState extends object | null = null> 
```
